...
Source: `packages/db/seed/catalog/activities.json`. One named PNG per catalog entry, both adult characters, three poses each, matching the selected v1 style and requested Wellness 2.0 clothing brand.
